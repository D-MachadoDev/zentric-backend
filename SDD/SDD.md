...
| **E-003** | [Product](Zentric.Domain/Products/Product.cs) | Agregado raíz | [Zentric.Domain/Products/Product.cs](../Zentric.Domain/Products/Product.cs) | Catálogo de productos. Gestiona variantes. Reglas [CAT-03](Domain/06-business-rules.md) (variante obligatoria en físicos). | Posee **E-004** (ProductVariant). Usa `Money`, `ProductType`. | ✅ **Implementado** — ADR-0002/0003 | [Products/ProductTests.cs](../Zentric.Tests/Products/ProductTests.cs) |
