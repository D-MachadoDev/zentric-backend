...
1. **No-negatividad de inventario (INV-01 / invariante 1).** Protegida en el
   ...
   (`Inventory.cs:33`, `[`:60`](../../Zentric.Domain/Inventories/Inventory.cs#L60)`, `[`:99`](../../Zentric.Domain/Inventories/Inventory.cs#L99)`, `[`:116`](../../Zentric.Domain/Inventories/Inventory.cs#L116)`, `[`:132`](../../Zentric.Domain/Inventories/Inventory.cs#L132)`).
...
5. **Usuario bloqueado no puede cambiar nombre, correo, contraseña ni rol.**
   `User.cs:52`, `[`:73`](../../Zentric.Domain/Users/User.cs#L73)`, `[`:96`](../../Zentric.Domain/Users/User.cs#L96)`, `[`:158`](../../Zentric.Domain/Users/User.cs#L158)`.
...
`[OBSOLETO — corregido el 2026-09-18]` El párrafo siguiente describía el estado del 2026-09-17. **Ya no es cierto:** existen los proyectos `Zentric.Application`, `Zentric.Infrastructure`, `Zentric.Api` y `Zentric.Tests` (ver :6). Se conserva tachado para trazabilidad.
...
[verification-baseline.md :7](verification-baseline.md#7-segunda-iteracion-suite-de-pruebas-y-correccion-t-003) y :8.
...
`[CONFIRMADO]` Estos artefactos existen en el working tree y **no estaban documentados** en :1–:5
...
| `Logistics/Entities/Shipment.cs` | entidad hija | `01-models` [`:5`](../../Zentric.Domain/Logistics/Entities/Shipment.cs#L5) | implementado |
...
- `PED-01`: reserva preventiva al añadir al carrito + liberación a los 15 minutos → **no implementado**.
